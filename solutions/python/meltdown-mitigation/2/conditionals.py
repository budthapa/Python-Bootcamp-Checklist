...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if overload < 90/100 * threshold:
        return "LOW"

    threshold_range = int(10/100 * threshold)
    threshold_range_min = threshold - threshold_range
    threshold_range_max = threshold + threshold_range
    
    if overload >= threshold_range_min and overload <= threshold_range_max:
        return "NORMAL"
    return "DANGER"
